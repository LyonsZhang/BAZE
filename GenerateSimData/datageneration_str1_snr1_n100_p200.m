...
datafile1 = fullfile([type '_snr' num2str(snr) '_n' num2str(n) '_p' num2str(p) 'simdata.xlsx']);
datafile2 = fullfile([type '_snr' num2str(snr) '_n' num2str(n) '_p' num2str(p) 'simdata.mat']);

xlswrite(datafile1,Y,1)
xlswrite(datafile1,X,2)
writetable(coeffs,datafile1,'Sheet',3)
save str1_snr1_n100_p200.mat
