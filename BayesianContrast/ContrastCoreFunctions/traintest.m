function [MSEpre,MSEtest,average,sem,FPR,FNR,FPN,FNN,sensitivity,specificity,precision,accuracy,etafinal,roc]=traintest(k,pid,nburnin,niter,p,Y,X,T,Xs,Ts,beta,a,Q,n,tau,nu,omega,seed,predict,cutoff,stand,pl,true_index,pathname,figname,doroc)
...
parfor i=1:k
    ...
    signal=round(var(Xtrain*beta(1:p)'),2);
    noise=round(var(Ytrain-Xtrain*beta(1:p)'),2);
    ...
    %betapre=stand.Sy*diag(1./stand.Sx(xindx))*invApre*Xpre'*Ytrain;
