...
parfor i=1:(ss+1)
    a=a0(i)*ones(1,p);
    [gamma,betahat,MSE]=gibbsgamma(nburnin,niter,p,nop,Y, X, T,Xs,Ts, a, Q, n,tau,nu,omega,seed,true,stand,false);
...
figname='cen_str2_snr1_'
%get the directory of your input files:
pathname = pwd;

save('censtable.mat','a0','FPR','TPR','FP','TN','FN','TP','mse')
...
%use that when you save
figfile1 = fullfile(pathname, [figname 'centeredstablenvs.eps']);
figfile2 = fullfile(pathname, [figname 'centeredstablenvs.pdf']);
saveas(gcf,figfile1,'epsc')
saveas(gcf,figfile2)
