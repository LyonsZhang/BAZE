...
%     raccuracy(((repeat-1)*k+1):(repeat*k),:)=roc.raccuracy;
    rAUC(repeat,:)=roc.rAUC; 
        ...
        [MSEpre,MSEtest,average,sem,FPR,FNR,FPN,FNN,sensitivity,specificity,precision,accuracy,etafinal]=traintest(k,nburnin,niter,p,Y, X, T,beta, a, Q, n,tau,nu,omega,seed,predict,cutoff,stand, pl,true_index,pathname,figname,dodoc);
    end
